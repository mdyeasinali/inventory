                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <header class="pull-right">
                                <a href="add_products.php?token=<?php echo $token; ?>" class="">
                            ...
                            <form method="post" id="form-delete" action="<?php Config::get('site/aciton'); ?>">
                                ...
                                <table class="table responsive-data-table data-table" id="checkAll">
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-xs"><i class="fa fa-image"></i> Image</th>
                                        <th><i class="fa fa-3x"></i>Code</th>
                                        <th><i class="fa fa-3x"></i>Title</th>
                                        <th><i class="fa fa-3x"></i>Brand</th>
                                        <th><i class="fa fa-3x"></i>Category</th>
                                        <th><i class="fa fa-3x"></i>Cost</th>
                                        <th><i class="fa fa-3x"></i>Price</th>
                                        <th><i class="fa fa-3x"></i>Quantity</th>
                                        <th><i class="fa fa-3x"></i>Unit</th>
                                        <th><i class="fa  fa-smile-o"></i>Publisher</th>
                                        <th><i class="fa  fa-smile-o"></i> Publish</th>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                                                               $row = $Products->show_all_products();
                                                                                foreach ($row as $key){
                                        ?>
