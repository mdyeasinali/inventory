        ...
        <div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="active"><a href="index.php?token=<?php echo $token ?>"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
                    
					<li><a href="partners.php?token=<?php echo $token ?>"><i class="fa fa-users"></i>  <span>Partners</span></a></li>
					<li><a href="agents.php?token=<?php echo $token ?>"><i class="fa fa-user"></i>  <span>Agents</span></a></li>
                    <li class="menu-list">
                        <a href="#"><i class="fa fa-reorder"></i>  <span>Products</span></a>
                        <ul class="child-list">
                            <li><a href="products.php?token=<?php echo $token ?>"><i class="fa fa-reorder"></i> <span>Product</span></a></li>
                            <li><a href="adjustment.php?token=<?php echo $token ?>"><i class="fa fa-reorder"></i> <span>Adjustment</span></a></li>
                        </ul>
                    </li>
					...
					<li class="menu-list">
                        <a href="#"><i class="fa fa-file-powerpoint-o"></i>  <span>CMS</span></a>
                        <ul class="child-list">
					...
					<li class="menu-list">
                        ...
                        <ul class="child-list">
                            <li><a href="slider.php?token=<?php echo $token ?>"><i class="fa fa-sliders"></i> Slider</a></li>
							<li><a href="frontend.php?token=<?php echo $token ?>"><i class="fa fa-cc-discover"></i> Frontend</a></li>
							<li><a href="advertising.php?token=<?php echo $token ?>"><i class="fa fa-share-square-o"></i> Advertising</a></li>
                        </ul>
                    </li>
					<li class="menu-list">
                        <a href="#"><i class="fa fa-line-chart"></i>  <span>Marketing </span></a>
                        <ul class="child-list">
                            <li><a href="newsletters.php?token=<?php echo $token ?>"><i class="fa fa-life-saver"></i> Newsletters</a></li>
                        </ul>
                    </li>
					<li class="menu-list"><a href="javascript:;"><i class="fa fa-envelope-o"></i> <span>Email <span class="label noti-arrow bg-danger pull-right">4 Unread</span> </span></a>
                        <ul class="child-list">
                            <li><a href="mail-inbox.php?token=<?php echo $token ?>"> Inbox</a></li>
                            <li><a href="mail-details.php?token=<?php echo $token ?>"> View Mail</a></li>
                            <li><a href="mail-compose.php?token=<?php echo $token ?>"> Compose Mail</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo $admin->admin_data('user_img');?>" alt="">  <?php echo $admin->admin_data('user_username');?>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                ...
                                <li><a href="<?php Config::get('site/action'); ?>?log-out=true&token=<?php echo $token?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
